...
class SolicitudController extends Controller
{
    ...
    public function leerSolicitud(string $usuario_receptor_id): JsonResponse
    {
        ...
        ->select('S.id', 'enviador.nombre as nombre', 'enviador.telefono', 
        'enviador.correo', 'P.titulo', 'S.fecha')
    ...
    public function leerSolicitudEnviador(string $usuario_enviador_id): JsonResponse
    {
        ...
        ->join('usuarios as receptor', 'receptor.id', '=', 'S.usuario_receptor_id')
        ->join('productousus as P', 'S.productousu_id', '=', 'P.id')
        ->select('S.id', 'enviador.nombre as nombre', 'enviador.telefono', 'enviador.correo', 'P.titulo', 
        'S.fecha','enviador.id as enviador_id',
        'receptor.id as receptor_id','P.id as productousu_id')
        ->where('S.usuario_enviador_id', '=', $usuario_enviador_id)
        ->get();
